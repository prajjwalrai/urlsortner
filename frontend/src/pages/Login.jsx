        ...
        <div className="flex min-h-screen items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="w-full max-w-md space-y-8 bg-slate-800 p-8 rounded-xl shadow-xl border border-slate-700 hover:-translate-y-[2px] transition-transform duration-300">
                <div className="text-center">
                    ...
                    <h2 className="mt-6 text-3xl font-bold tracking-tight text-slate-100">Sign in to QuickLink</h2>
                </div>
                ...
                <p className="text-center text-sm text-slate-400">
                    ...
                    <Link to="/register" className="font-semibold text-blue-500 hover:text-blue-400 transition-colors">Sign up</Link>
                </p>
            </div>
        </div>
    );
